...
sed -i -e "s|https://github.com/LukeTheGit/apexcharts-card/releases/download/.*/apexcharts-card.js|https://github.com/LukeTheGit/apexcharts-card/releases/download/v${VERSION}/apexcharts-card.js|g" ./README.md
